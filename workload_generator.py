...
parser.add_argument('--url', type=str, help='URL to the backend server, e.g. http://127.0.0.1:8000/')
parser.add_argument('--image_folder', type=str, help='/face_images_1000')
parser.add_argument('--prediction_file', type=str, help='/face_images_1000.csv')
